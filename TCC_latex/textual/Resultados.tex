...
organização estrutural e semântica da rede.

Os mesmos algoritmos e procedimentos de cálculo foram 
utilizados nas duas estratégias de construção das redes 
consideradas neste trabalho. Na primeira abordagem, 
o limiar mínimo de similaridade foi determinado de forma 
variável para cada período, de acordo com o procedimento 
de conectividade descrito anteriormente. 
Na segunda, foi utilizado o limiar fixo de 0,72. 
Dessa forma, tanto o algoritmo de Leiden quanto 
as três medidas de centralidade e as oito formas de 
agregação dos indicadores foram mantidos constantes 
nas duas abordagens, permitindo avaliar os efeitos 
decorrentes exclusivamente da alteração do critério 
utilizado para a formação das relações de similaridade.